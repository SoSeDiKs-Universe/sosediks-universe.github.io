...
### {% href_link ❓️ | Невідомі прокляття %}
Прокляття приховані в описі предметів за замовчуванням, замість цього просто зазначається, що предмет проклятий, і назва предмета стає червоною.

Прокляття більше не надають блиску зачарування.

### {% href_link 🎩 | Благословення відвʼязування %}
Ефект `«Прокляття привʼязування»`{: .mc-red} можна обійти за допомогою посиленого зілля `«Слабкости»`{: .mc-aqua}.
...
Предмети відображають атрибути/ефекти/зачарування іконками.
