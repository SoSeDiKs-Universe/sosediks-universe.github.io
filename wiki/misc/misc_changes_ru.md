...
### {% href_link ❓️ | Неизвестные проклятия %}
Проклятия скрыты в описании предметов по умолчанию, вместо этого просто отмечается, что предмет проклят, и название предмета становится красным.

Проклятия больше не придают блеска зачарований.

### {% href_link 🎩 | Благословение съёмности %}
Эффект `«Проклятия несъёмности»`{: .mc-red} можно обойти при помощи усиленного зелья `«Слабости»`{: .mc-aqua}.
...
Предметы отображают атрибуты/эффекты/зачарования иконками.
