...
Для общения между участниками используется [Discord](https://discord.gg/vrMgAsXK8z){: .discord}.
</div>
...
Основная активность между участниками происходит в нашем [Discord](https://discord.gg/vrMgAsXK8z){: .discord} сервере.
