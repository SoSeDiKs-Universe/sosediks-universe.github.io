...
Вы можете войти на сервер по адресу: `sosedik.com`{: .mc .mc-gold}. Сейчас сервер находится на версии `1.19.4`{: .mc .mc-gold}.
...
### 🌡️ Температура
Между сердцами и голодом/жаждой также доступен индикатор ощущения температуры игроком. В зависимости от состояния игрока, индикатор красится либо красным, либо синим. Целью является поддержание индикатора в нейтральном цвете — сером (на жарко, ни холодно).
...
Получения жара или обморожения чревато негативными эффектами, в конечном счёте приводя к смерти от гипертермии или гипотермии.
...
### 🧤 Второй слот брони и перчатки
Помимо обычных четырёх слотов для брони добавлены также 4 визуальных слота брони и слот под перчатки.

Обычная броня не отображается на игроке и может быть просмотрена только при переключении вида в инвентаре, но при этом влияет на характеристики (напр., сопротивление урону).

Второй слот брони отображается на игроке и влияет на температуру. Визуальный слот шлема может содержать в себе любой предмет (в количестве 1шт.).

Перчатки необходимы, чтобы удерживать в руке горячие предметы, набирать лаву (или воду в холодных биомах) в ведро и безопасно разрушать некоторые блоки (напр., стекло).

### 📖 Читабельные книги в рамках
Книги, размещённые в рамках, можно читать при помощи ПКМ.

Книги поддерживают форматирование при помощи MiniMessage и Markdown. Предосмотр форматирования помимо рамки также возможен через Shift + ПКМ.
...
Таблички поддерживают форматирование при помощи MiniMessage и Markdown.
...
- Вагонетка с динамитом может быть активирована огнивом (прим.: предмет с зачарованием «Заговор огня» действует как огниво) и огненным зарядом (четыре секунды до взрыва).
