...
- Единый связанный чат между Дискордом и сервером Minecraft.
...
### 👻 Первый взгляд
Впервые зайдя на сервер, игрок начинает игру в режиме призрака. Целью на даном этапе игры является заполучение человеческого обличия. После успешного перерождения начинается "обычное" (усложнеённое) выживание. Подробнее о режиме можно узнать ниже.
...
### 💧 Жажда
[В разработке] Дополнительным аспектом, требующим внимания игрока, является жажда.
...
### 🔱 Изменения трезубца
Трезубец с зачарованием «Пронзатель» наносит дополнительный урон сущностям, находищимся в воде (включая дождь), а не только морским мобам.
...
Ножницы позволяют предотвратить взрыв зажённого динамита.

### 🫗 Бутылочки воздуха
При наполнении воды под водой бутылочки восполяют немного воздуха.
...
Подобно Bedrok версии, стойки могут принимать различные позы в зависимости от сигнала редстоуна. При максимальном сигнале стойка принимает случайную из поз.
...
### 🎯 Зажённые стрелы распространяют огонь
Зажённые стрелы создают огонь при приземлении.
...
При наличии зачарования «Шёлковое касание» на инструменте возможно подобрать зажённый костёр.
...
При разрушении брошенного зелья около зажённого костра, он подхватывает эффект зелья и начинает накладывать его на игроков вокруг себя.
...
Таблички больше не редактируются сразу при установке, но их можно изменять в любое время. Для этого необходимо нажать по ним ПКМ с зажатим Shift.
...
### 🚧 Улучшенный забор
Игроки могут перепрыгивать одинарный забор, но он всё ещё является препядствием для остальных сущностей.
...
### 🔥 Панический огонь
Горение (не имея средст защиты на подобии огнестойоксти) заставляет игрока в панике бежать вперёд.

### 🧯 Распространение огня
Если горящая сущность атакует кого-то, то цель может перейнять огонь.

Атаки источником огня (напр., факел) тоже можут поджечь цель.
...
- Использование ПКМ пустой рукой по вагонетке с печкой позволяет "толкнуть" её.
...
При аккуратном использовании также может спасти лодку от утопания или помочь плыть вверх против течения.
...
Дополнительно, при помощи `/sit` можно сесть на землю в любом месте.
...
### 🧟 Живучая нежить
Зомби, скелеты и Визер имеют сопротивление большинству видам урона, а также могут регенерировать. Обычная нежить теряет сопротивление, если горит. Нежить из Незера восприимчива только к святому урону (зачарование «Небесная кара»).
...
Помимо этого, во время занятий любовью свиньи могут воспроизводить обычную землю.
...
Если цель эндермена нагодится в зоне недосягаемости, они могут её телепортировать.
...
Снеговищи сбрасывают тыкву при стрижке.
...
При атаке фантомы испускают огонь.

Фантомы орбирируют (летают вокруг) крислаллов Энда.
...
### ⛑️ Командные шлемы
Если у игроков шлемы или нагрудники одинавого цвета, то они не наносят урон друг другу.
...
- Неразрушаемость ([MC-98160](https://bugs.mojang.com/browse/MC-98160){: .mc .mc-gold}) и отсутствие урона ([MC-105103](https://bugs.mojang.com/browse/MC-105103){: .mc .mc-gold}) при падении лодки с большой высоты.
...
- Сёдла сохраняют свои характеристики (название, лор…) при надевании/снимании с ездовых сущностей.
...
### Что? #11
Карта местности, созданная в Незере, показывает блоки на той высоке, на которой чистая карта была применена.
