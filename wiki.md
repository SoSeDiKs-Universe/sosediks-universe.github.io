...
Вы можете войти на сервер по адресу: `sosedik.com`{: .mc .mc-gold}. Сейчас сервер находится на версии `1.20.4`{: .mc .mc-gold}.
...
Если в основной руке молоток, а в другой блок, то при ломании блока (требуется наличие соответствующего инструмента) он заменится на тот, что в руке. Например, если держать молоток и дубовые ступеньки и начать ломать акациевые ступеньки при наличии топора в инвентаре, то при поломке ступеньки сразу заменятся с сохранением положения. Приба инструмента потеряют единицу прочности.
...
### 🐈 Котейка не даёт открыть сундук?
Открытие сундука отбрасывает сущности на сундуке в направлении крышки. Но будьте осторожны! Если позади сундука стена или во время закрытия крышки на сундуке находится моб, то сущность получит единицу урона.
