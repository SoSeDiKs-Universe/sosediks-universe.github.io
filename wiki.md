...
Вы можете войти на сервер по адресу: `sosedik.com`{: .mc .mc-gold}. Сейчас сервер находится на версии `1.19.3`{: .mc .mc-gold}.
...
Также присутствует ограничение на строительство в темноте. Игрок не станет размещать блок, если вокруг кромешная тьма. И да, это значит, что можно закопать себя в землю без возможности выбраться! >:)
